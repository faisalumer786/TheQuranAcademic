...
<head>
    ...
    <title>The Quran Educators</title>
</head>
<body>
      ...
      <div class="col-12 col-lg-9 col-xl-7">
        ...
        <div class="position-relative m-3 d-flex justify-content-center">
          ...
          <div class="card-body p-4 p-md-5">
            <h3 class="text-center m-3">Registration For Academic Courses</h3>
            <!-- <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 text-center">BlockChain</h3> -->
